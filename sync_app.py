...
def main():
    ...
    #httpd.socket = ssl.wrap_socket(httpd.socket, certfile=r"D:\文档,音频\anki\anki_custom_server_vip\localhost+3.pem",keyfile=r"D:\文档,音频\anki\anki_custom_server_vip\localhost+3-key.pem",server_side=True, ssl_version=ssl.PROTOCOL_TLSv1_2)
    try:
